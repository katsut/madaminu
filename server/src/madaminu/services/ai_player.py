...
AI_CHARACTER_TEMPLATES = [
    {
        ...
        "character_appearance": "小柄でふくよかな体型。いつもエプロンをしている。",
    ...
    },
    {
        ...
        "character_appearance": "銀縁眼鏡をかけた痩身の男性。白髪交じりの髪。",
        "character_personality": "慎重で理論的。物事を冷静に分析する。",
        "character_background": "犯罪心理学を専門とする大学教授。",
    },
    {
        ...
        "character_appearance": "ショートカットで活発な印象。常にメモ帳を持っている。",
    ...
    },
    {
        ...
        "character_appearance": "がっしりした体格。穏やかな目つきだが鋭い眼光。",
    ...
    },
    {
        ...
        "character_appearance": "長い黒髪を一つにまとめている。静かな雰囲気。",
    ...
    },
    {
        ...
        "character_appearance": "日焼けした肌と太い腕。豪快な笑顔。",
