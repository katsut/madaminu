...
class Player(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    character_name_kana: Mapped[str | None] = mapped_column(String(100), nullable=True)
    character_gender: Mapped[str | None] = mapped_column(String(10), nullable=True)
    character_age: Mapped[str | None] = mapped_column(String(10), nullable=True)
    character_occupation: Mapped[str | None] = mapped_column(String(100), nullable=True)
    character_appearance: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    public_info: Mapped[str | None] = mapped_column(Text, nullable=True)
